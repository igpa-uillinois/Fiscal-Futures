...
rev_temp %>% 
  ...
  labs(title = "Federal to State Transfers without Stimulus Funds", 
       caption = "These values EXCLUDE stimulus funds after the Great Recession and the COVID pandemic response.",
       y = "Millions of Dollars", x = "") + 
  theme(legend.position = "bottom", legend.title = element_blank()  )
```
